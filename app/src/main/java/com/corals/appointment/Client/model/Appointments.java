 ...
 * Appointments
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-07-18T15:23:27.628Z")
public class Appointments {
   ...
   @Schema(description = "")
    ...
    public Appointments slotNo(String slotNo) {
        this.slotNo = slotNo;
        return this;
    }
    /**
   ...
   @Schema(description = "")
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.customerId, appointments.customerId) &&
                ...
                Objects.equals(this.slotNo, appointments.slotNo);
    }
    @Override
    public int hashCode() {
        return Objects.hash(customerId, merId, startTime, endTime, serId, resId, apptId, allowed, booked, slotNo);
    }
    @Override
